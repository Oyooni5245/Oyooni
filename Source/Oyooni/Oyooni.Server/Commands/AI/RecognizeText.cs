...
namespace Oyooni.Server.Commands.AI
{
    ...
    public class RecognizeText
    {
        ...
        /// </summary>
        public class Request : IRequest<(string, string[], string, string, string)>
        {
            /// <summary>
        ...
        /// </summary>
        public class Handler : IRequestHandler<Request, (string, string[], string, string, string)>
        {
            /// <summary>
            ...
            /// </summary>
            public async Task<(string, string[], string, string, string)> Handle(Request request, CancellationToken token)
            {
